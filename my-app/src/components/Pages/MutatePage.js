        ...
        <Skeleton isLoaded={!loading}>
          ...
          <FormControl>
            ...
            <FormHelperText>
              ...
              adjust the image, and each adjustment will be smaller, and thus
              will yield a more precise, detailed image. Increasing steps comes
              at the expense of longer render times.
            </FormHelperText>
          </FormControl>
          <FormControl>
          ...
          <FormControl>
            ...
            <FormHelperText>
              Additional cuts are memory intensive. You can use "cutn_batches"
              to increase cuts per timestep without increasing memory usage.
            </FormHelperText>
          </FormControl>
          <FormControl>
          ...
          <FormControl>
            ...
            <FormHelperText>
              ...
              will overshoot the goal and distort the image. So a happy medium
          ...
          <FormControl>
            ...
            />
            <FormHelperText>
              Flag as NSFW. This does NOT mean you can render illegal or
