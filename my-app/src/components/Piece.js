...
import {
    ...
    Stack, Code,  
    Center, Button,
    HStack, VStack, Flex, useClipboard, Skeleton 
          ...
          <VStack alignItems={"left"} paddingLeft={3} paddingRight={3}>
            <VStack>
              ...
              <Stack direction='row'>
                ...
                <Badge variant='outline' colorScheme='blue'>{data.views} Views</Badge>
              </Stack>
              <VStack>
                <Code width="80%" variant={"solid"} p={8} borderRadius="sm" borderWidth="1px" bg={`rgb(${data.dominant_color[0]},${data.dominant_color[1]},${data.dominant_color[2]},0.5)`}>{tp}</Code>
